...
from rouge_score import rouge_scorer # https://github.com/google-research/google-research/blob/master/rouge/rouge_scorer.py
...
def main():
    ...
    def compute_metrics(p: EvalPrediction):
        ...
        results = {}
        results['rouge1'] = round(rouge1/total_count * 100, 2)
        results['rouge2'] = round(rouge2/total_count * 100, 2)
        results['rougeL'] = round(rougeL/total_count * 100, 2)
    ...
    def post_processing_function(
        examples: datasets.Dataset, features: datasets.Dataset, outputs: EvalLoopOutput
    ):
