...
output_dir=/afs/crc.nd.edu/group/dmsquare/vol2/myu2/ComparisonSentences/experiments/multi-news/test_pred_1205
data_dir=/afs/crc.nd.edu/group/dmsquare/vol2/myu2/ComparisonSentences/downloaded/multi_doc_summ/multi-news_pairwise

CUDA_VISIBLE_DEVICES=2 /afs/crc.nd.edu/user/m/myu2/anaconda2/envs/bert/bin/python3.7 /afs/crc.nd.edu/group/dmsquare/vol2/myu2/ComparisonSentences/code/6.downstream/run_pairwise_cross.py \
