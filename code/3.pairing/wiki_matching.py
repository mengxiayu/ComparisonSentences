            ...
            with open (batch_file) as f:
                ...
                for linenum,line in enumerate(f):
                    ...
                    for para in paragraphs:
                        ...
                        for sent in sent_tokenize(para.strip()):
...
def get_arg_parser():
    ...
    parser.add_argument('--dir_output', type=str, default="/afs/crc.nd.edu/group/dmsquare/vol2/myu2/ComparisonSentences/data/statement_scoring/wiki_v1")
    return parser
